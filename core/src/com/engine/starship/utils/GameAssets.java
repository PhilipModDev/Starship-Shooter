...
public class GameAssets implements Disposable {
    ...
    public TextureAtlas asteroidAtlas;
    ...
    public static RegistryAsset<TextureAtlas.AtlasRegion> tierOneStarShip;
    public static RegistryAsset<TextureAtlas.AtlasRegion> tierTwoStarShip;
    public static RegistryAsset<TextureAtlas.AtlasRegion> tierThreeStarShip;
    public static RegistryAsset<TextureAtlas.AtlasRegion> tierFourStarShip;
    ...
    public static RegistryAsset<TextureAtlas.AtlasRegion> cTypeAsteroid;
    public static RegistryAsset<TextureAtlas.AtlasRegion> sTypeAsteroid;
    ...
    public static RegistryAsset<TextureAtlas.AtlasRegion> rocket;
    ...
    public GameAssets(AssetManager manager){
        ...
        this.assetManager.load(Constants.ASTEROID_TEXTURE_ATLAS,TextureAtlas.class);
    ...
    public void init(){
        ...
        asteroidAtlas = assetManager.get(Constants.ASTEROID_TEXTURE_ATLAS);
        ...
        cTypeAsteroid = new RegistryAsset<>(findAsteroidRegion("c_type_asteroid"));
        sTypeAsteroid = new RegistryAsset<>(findAsteroidRegion("s_type_asteroid"));
        ...
        uraniumGem = new RegistryAsset<>(findRegion("uranium_gem"));
        tierOneStarShip = new RegistryAsset<>(starship.getAssets().get(0));
        tierTwoStarShip = new RegistryAsset<>(findRegion("white_starship"));
    ...
    public void loadConfigs(){
       try {
           FileHandle fileHandle = Gdx.files.local(Constants.RESOURCE_LOCATION+"configs.json");
    ...
    public TextureAtlas.AtlasRegion findAsteroidRegion(String name){
        if (asteroidAtlas == null) return new TextureAtlas.AtlasRegion(missing);
        return asteroidAtlas.findRegion(name);
    }
