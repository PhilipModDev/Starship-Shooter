...
public class CreditsMenu extends MenuObject{
    ...
    @Override
    public void show() {
        BitmapFont uiFont = StarshipShooter.getInstance().gameAssets.getLocalization().getAllLanguages();
        ...
        creditsList.addListener(new ActorGestureListener(){
          ...
          public void tap(InputEvent event, float x, float y, int count, int button) {
              ...
              if (selectedItem.equals("PhilipModDev (Lead Software Developer)")){
                  Gdx.net.openURI("https://www.youtube.com/@PhilipModDev");
              } else if (selectedItem.equals("OFFICIAL Biscuit_MC_YT (Lead Artist)")){
