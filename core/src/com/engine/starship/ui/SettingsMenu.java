...
public class SettingsMenu extends MenuObject {
    ...
    public void show() {
        ...
        //Table Layouts.
        root.row();
        root.add(audio).expand().center().right().bottom().width(150).height(150).spaceRight(100);
        root.add(particleCheck).expand().center().left().bottom().width(150).height(150);
        root.row();
        root.add(home).expand().center().right().width(150).height(150).padLeft(100).spaceRight(100);
